 ...
 */
public class IntWccVertexDataNullTextInputFormat extends
    TextVertexInputFormat<IntWritable, WccVertexData, NullWritable> {
  ...
  public TextVertexReader createVertexReader(InputSplit split,
    ...
    throws IOException {
    return new IntWccVertexDataNullVertexReader();
  }

  /**
   * Vertex reader associated with {@link IntIntNullIntTextInputFormat}.
   */
  public class IntWccVertexDataNullVertexReader extends
    ...
    @Override
    protected WccVertexData getValue(String[] tokens) throws IOException {
      return new WccVertexData();
    }
